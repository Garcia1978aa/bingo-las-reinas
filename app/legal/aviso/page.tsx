export default function AvisoLegalPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-8 text-[#E6E18F]">Aviso Legal</h1>
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <h2>2. Objeto</h2>
        <p>
          El presente aviso legal regula el uso del sitio web bingoreinascarton.com, que BINGO Las Reinas del Cartón
          pone a disposición de los usuarios de Internet.
        </p>

        <h2>3. Condiciones Generales de Uso del Establecimiento</h2>
        <p>
          Queda prohibida la entrada a menores de 18 años a Bingo Las Reinas del Cartón, ya que en el local se sirven
          bebidas alcohólicas, conforme a las normativas de protección a menores y venta de alcohol. La organización se
          reserva el derecho a solicitar documento de identidad para verificar la edad de los asistentes.
        </p>
